<?php
/**
 * Presence penalty field template.
 *
...
<input type="number" step="0.1" min="-2" max="2"
	...
	id="minimax_presence_penalty"
	value="<?php echo esc_attr( (string) $value ); ?>"
	class="small-text" />
<p class="description"><?php echo esc_html__( 'Penalizes tokens that have appeared in the output so far. Range: -2 to 2.', 'alamin-ai-provider-for-minimax' ); ?></p>
