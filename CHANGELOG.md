...
- Directory listing copy: the readme title, tags and short description now lead with "connector" and name image generation, matching what people search the plugin directory for. No code changes.
